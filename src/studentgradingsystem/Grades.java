...
public class Grades implements Serializable {
    ...
    private String grd_letter;
    
    public Grades(int grd_id, int std_id, int crs_id, float grd_mt, float grd_hw, float grd_final, String grd_letter) {
        this.grd_id = grd_id;
        this.std_id = std_id;
        this.crs_id = crs_id;
        this.grd_mt = grd_mt;
    ...
    public String getGrd_letter() {
        return grd_letter;
    }

    public void setGrd_letter(String grd_letter) {
        this.grd_letter = grd_letter;
    }
}
